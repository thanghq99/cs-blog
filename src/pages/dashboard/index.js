...
const Tile = ({ item }) => {
  return (
    <Link href={item.url} legacyBehavior>
      <a
        className={`w-full my-2 py-10 text-center text-3xl uppercase font-semibold shadow-md shadow-red-600 tracking-wider transition bg-red-500 text-black lg:hover:text-4xl lg:hover:tracking-widest lg:hover:shadow-xl lg:hover:shadow-red-700 `}
      >
        {item.name}
      </a>
    </Link>
